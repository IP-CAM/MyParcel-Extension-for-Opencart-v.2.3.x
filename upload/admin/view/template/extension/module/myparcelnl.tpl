                ...
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-html" class="form-horizontal">
                    <div class="tab-pane">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10 col-md-6 col-lg-6">
                                    ...
                                    <div class="radio">
                                        <label>
                                            <input type="radio" name="myparcelnl_fields_general[use_addition_address_as_number_suffix]" value="2" <?php echo (isset($myparcelnl_fields_general['use_addition_address_as_number_suffix'])&& ($myparcelnl_fields_general['use_addition_address_as_number_suffix']==2))?'checked="checked"':""; ?>/>
                                            <span><?php echo $entry_tab_1_checkbox_use_address3_as_number_suffix_1; ?> </span>
                                            <?php if(count($custom_field_address)) { ?>
                                            <select class="form-control" id="select_homenumber_suffix" name="myparcelnl_fields_general[general_custom_field_homenumber_suffix]"  >
                                                <?php foreach($custom_field_address as $custom_field ){ ?>
                                                <?php $selected = (isset($myparcelnl_fields_general['general_custom_field_homenumber_suffix']) && $myparcelnl_fields_general['general_custom_field_homenumber_suffix'] ==  $custom_field['id'] ) ? 'selected="selected"' : '' ; ?>
                                                <option <?php echo  $selected; ?> value="<?php echo  $custom_field['id']; ?>"><?php echo $custom_field['name']; ?></option>
                                                <?php } ?>
                                            </select>
                                            <?php } ?>
                                            <span><?php echo $entry_tab_1_checkbox_use_address3_as_number_suffix_2; ?></span>
                                        </label>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-10 col-md-6 col-lg-6">
                                    <table class="table_shipping_methods_package_types">
                                        ...
                                        <tr>
                                            ...
                                            <?php if($package_code == $digital_stamp_code){ ?>
                                            <td>
                                                <?php echo $entry_tab_2_default_weight ?>
                                            </td>
                                            <td style="min-width: 200px;">
                                                <select name="myparcelnl_fields_export[digital_stamp_default_weight]" class="form-control" style="width:100%;">
                                                    <?php foreach ($digital_stamp_default_weight as $key => $weight) : ?>
                                                    <?php $selected = (isset($myparcelnl_fields_export['digital_stamp_default_weight']) && $myparcelnl_fields_export['digital_stamp_default_weight'] == $key) ? 'selected="selected"' : '' ; ?>
                        ...
                        <div class="tab-pane" id="tab-checkout">
                            ...
                            <h4><?php echo $entry_tab_3_enable_myparcel_shipping_message; ?></h4>
                            <div class="form-group">
                            ...
                            <div id="settings_delivery" class="<?php echo (isset($myparcelnl_fields_checkout['enable_delivery']) && ($myparcelnl_fields_checkout['enable_delivery']==1))?'show':'hidden';?>">
                                ...
                                <h4><strong><?php echo $entry_tab_3_label_only_apply_for_xtension_checkout; ?></strong></h4>
                                <div class="form-group">
                                    <label class="text-left col-sm-2 control-label" for="input-title" ><?php echo $entry_tab_3_label_distance; ?></label>
                                    <div class="col-sm-10 col-md-6 col-lg-3">
                                        <select name="myparcelnl_fields_checkout[distance_format]" class="form-control" style="width:100%;">
                                            <?php foreach($distance_format as $key => $value){
                                            $selected = (isset($myparcelnl_fields_checkout['distance_format']) and $key == $myparcelnl_fields_checkout['distance_format'] ) ? 'selected="selected"' : '' ;
                                            ?>
                                ...
                                <div class="form-group">
                                    <label class="text-left col-sm-2 control-label" for="input-title" ><?php echo $entry_tab_3_label_rounding_distance; ?></label>
                                    <div class="col-sm-10 col-md-6 col-lg-3">
                                        <input type="" name="myparcelnl_fields_checkout[rounding_distance]" value="<?php echo !empty($myparcelnl_fields_checkout['rounding_distance']) ? $myparcelnl_fields_checkout['rounding_distance'] : ''; ?>" class="form-control"/>
                                        <?php echo $entry_tab_3_label_rounding_distance_description; ?>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="text-left col-sm-2 control-label" for="input-title" ><?php echo $entry_tab_3_label_default_price_0_text; ?></label>
                                    <div class="col-sm-10 col-md-6 col-lg-3">
                                        <input type="" name="myparcelnl_fields_checkout[default_price_0_text]" value="<?php echo !empty($myparcelnl_fields_checkout['default_price_0_text']) ? $myparcelnl_fields_checkout['default_price_0_text'] : ''; ?>" class="form-control"/>
                                        <?php echo $entry_tab_3_label_default_price_0_text_description; ?>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label class="text-left col-sm-2 control-label" for="input-title" ><?php echo $entry_tab_3_label_time_format; ?></label>
                                    <div class="col-sm-10 col-md-6 col-lg-3">
                                        <input type="" name="myparcelnl_fields_checkout[time_format]" value="<?php echo !empty($myparcelnl_fields_checkout['time_format']) ? $myparcelnl_fields_checkout['time_format'] : 'H:i:s'; ?>" class="form-control"/>
                                        <?php echo $entry_tab_3_label_time_format_description; ?>
                                    </div>
                                </div>
